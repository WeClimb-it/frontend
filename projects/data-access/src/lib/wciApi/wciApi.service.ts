...
import { ApolloService, ApolloServiceOptions } from './apollo.service';
import { WCI_API_SERVICE_OPTIONS } from './injectionTokens';

@Injectable({ providedIn: 'root' })
export class WciApiService {
  constructor(
    private service: ApolloService,
    @Inject(WCI_API_SERVICE_OPTIONS) wciApiServiceOptions: ApolloServiceOptions,
  ) {
    ...
    this.service.init(wciApiServiceOptions);
  }
